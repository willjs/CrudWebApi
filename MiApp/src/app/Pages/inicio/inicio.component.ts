...
export class InicioComponent {
  ...
  public displayedColumns : string[] = ['nombreDescripcion','direccion','identificacion','moneda','fechaCreacion','accion'];
  ...
  eliminar(objeto:Empleado){
    if(confirm("Desea eliminar el empleado" + objeto.nombreDescripcion)){
